        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full p-6 md:p-12 py-16 md:py-24 flex items-center justify-center text-white">
            <div className="text-center">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8 mt-8">
                {/* USA Salary Block */}
                <div className="bg-white/20 backdrop-blur-sm p-4 rounded-lg border border-white/30 text-white">
